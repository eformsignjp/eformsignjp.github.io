...
.. note::
   ...
   Microsoft Office アドイン（Add-in）機能（OZ in Office フォームビルダー）も用意されており、Microsoft Office から電子文書を直接生成することもできます。フォームビルダーについては、 `フォームビルダーの紹介 <#formbuilder>`__ を参考に、Microsoft Office にフォームビルダーをインストールしてから使用してください。
...
-  **文書番号：** **テンプレートの設定 > 全般**\ で設定した文書番号です。文書番号の設定については、\ `文書番号の自動生成 <#docnumber_wd>`__\ をご参照ください。
...
.. note::
   ...
   テンプレートの詳細な説明については、\ `Web フォームデザイナー <#template_wd>`__\ をご参照ください。
