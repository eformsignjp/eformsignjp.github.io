...
3. **AIアシスタント** 機能を使用する場合、分析類型を選択し、**AI分析**\ をクリックします。
...
.. Tip::
   ...
   💡 **AIアシスタント**\ を使用すると、AIが文書を自動で分析し、入力項目の位置や種類を自動的に設定・配置します。

      - **基本分析:** 文書内の入力項目の位置と種類を分析し、自動配置します。
      - **高度な分析:** 基本分析に加え、参加者や作成権限などの入力項目の属性やワークフローまで自動設定します。

      AIアシスタントは、いつでも左上のアイコンをクリックして利用できます。 
   ...
   **※ 注意事項**
      ...
      - 文書の構成やサイズによって分析にかかる時間は異なり、高度な分析の場合は時間がかかることがあります。
      - 高度な分析を選択した場合でも、ファイルが20ページ以上の場合は基本分析が実行されます。
      - AIによる分析結果は完全ではないため、追加された入力項目は必ずご確認ください。

4. 文書に参加する署名者や役割を追加・設定すると、文書に入力項目を追加できる「デザインする」画面が表示されます。
...
3. **AIアシスタント** 機能を利用する場合は、分析タイプを選択した後、**AI分析**\ をクリックします。

   .. figure:: resources/AI-assistant-popup_jp.png
      :alt: AIアシスタントポップアップ
      :width: 400px

4. 文書に参加する署名者および役割を追加・設定すると、**デザインする** 画面が表示されます。

   .. figure:: resources/web-form_3_jp.png
      :alt: ウェブフォームデザイナー画面
      :width: 400px
...
**マイファイルで文書作成**\ の場合、 **デザインする、受信先を指定する、オプション**\ の3段階が表示され、デザインするを完了して文書作成を開始するか、下書きとして保存することができます。
